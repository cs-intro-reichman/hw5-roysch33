...
public class Scrabble {
	...
	public static String createHand() {
		String randomString = "";
		double randomIndex1 = Math.floor(Math.random() * 10);
		double randomIndex2 = Math.floor(Math.random() * 10);
	...
	public static void playHand(String hand) {
		...
		In in = new In();
		while (n.length() > 0) {
			System.out.println("Current Hand: " + MyString.spacedString(n));
